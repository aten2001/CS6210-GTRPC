...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//Handler for Proxy
class FifoCacheHandler : virtual public FifoCacheIf {
public:
	SimpleHash cacheTable = 1000;		//Hash table of size 1000

	//Constructor
	FifoCacheHandler(int size) {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<FifoCacheHandler> handler(new FifoCacheHandler(atoi(argv[1])));
  shared_ptr<TProcessor> processor(new FifoCacheProcessor(handler));
